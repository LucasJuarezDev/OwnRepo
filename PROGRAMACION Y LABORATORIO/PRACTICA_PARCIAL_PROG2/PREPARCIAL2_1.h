...
public:
   ...
   void setIDequipo(int _idEquipo) {idEquipo = _idEquipo;}
   void setNombre(const char *_Nombre)    {strcpy(nombre, _Nombre);}
   void setApellido(const char *Apellido)  {strcpy(apellido, Apellido);}
   void setFechaInscripcion(Fecha _inscripcion) {inscripcion = _inscripcion; }
...
public:
   ...
   void setEstado(bool e){estado=e;}
   void setIDdeporte(int _idDeporte) { idDeporte = _idDeporte; }
   void setIDCategoria(int _IDCategoria) { idCategoria = _IDCategoria;}
   void setNombre(const char *_Nombre){strcpy(nombre, _Nombre);}
   void Mostrar(){
